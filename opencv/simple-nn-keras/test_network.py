...
# A simple neural network with Python and KerasPython
...
# loop over tour testing images
for image_path in paths.list_files(test_images_path):
    # load the image, resize it to a fixed 32 x 32 pixels (ignoring
    # aspect ratio), and then extract features from it
    print("[INFO] classifying {}".format(image_path[image_path.rfind("/") + 1:]))
